...
- Report transport establishment and verification of the original PONG. Preserve stale selected-path evidence without changing serving state. Distinguish target failure, checker failure, stale state and quota exhaustion.
