...
Candidate type is the provider's authenticated assertion. Actual selected candidate pair, transport family, pinned DTLS, channel labels/reliability and the single ping/pong still require native runtime observation. An SDP candidate or a valid signature is not reachability evidence.
