...
tasks.processTestResources {
    ...
    from(rootProject.file("docs/external-signaling")) {
        include("diagnostic-answer-v1.fixtures.json", "diagnostic-v1.fixtures.json", "stateless-admission-v1.fixtures.json", "cloudburst-protocol-vectors.v1.json", "provenance.json")
        into("nxs")
    }
}
