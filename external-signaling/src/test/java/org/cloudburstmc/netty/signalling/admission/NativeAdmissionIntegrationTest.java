...
import org.cloudburstmc.netty.signaling.admission.AdmissionValidator;
import org.cloudburstmc.netty.signaling.admission.AdmittedNetherNetChildChannel;
...
import org.cloudburstmc.netty.signaling.admission.NetherNetFrameDecoder;
import org.cloudburstmc.netty.signaling.admission.NetherNetPacket;
import org.cloudburstmc.netty.signaling.admission.StatelessAdmissionValidator;
...
class NativeAdmissionIntegrationTest {
    ...
    void noControlLazyJoinBothChannelsReplayAndCleanup() throws Exception {
        ...
        try {
            ...
            try (PeerConnection client = PeerConnection.createPeer(
                ...
                var answer = TestSignallingProvider.answer(client.localDescription(), id.fingerprint(), port,
                        System.currentTimeMillis() + 30_000, TestSignallingProvider.AUDIENCE, false);
                var expired = TestSignallingProvider.answer(client.localDescription(), id.fingerprint(), port,
                        System.currentTimeMillis() - 1_000, TestSignallingProvider.AUDIENCE, false);
                var wrongHost = TestSignallingProvider.answer(client.localDescription(), id.fingerprint(), port,
    ...
    void simultaneousClientsRespectNativeCapacityUntilActualTeardown() throws Exception {
        ...
        try {
            ...
            var answers = new ArrayList<TestSignallingProvider.Answer>();
