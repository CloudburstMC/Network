...
final class TestSignalingProvider {
    ...
    static Answer answer(String offer, String fingerprint, int port, long expiry, String audience,
        ...
        return answer(
                offer, fingerprint, port, expiry, audience, wrongClientFingerprint, "K001", SECRET);
    }
    ...
    static Answer answer(
            ...
            long expiry,
            String audience,
            boolean wrongClientFingerprint,
            String keyId,
            String secret)
            throws Exception {
        ...
        byte[] identityBinding =
                Arrays.copyOf(
                        hmac(
                                utf8(secret),
                                "nxs-identity-binding-v1\0" + audience + "\0" + IDENTITY_CPK),
                        16);
        ...
        cipher.updateAAD(
                utf8("nxs-stateless-admission-v1\0NXS1" + keyId + "\0" + audience + "\0" + ufrag));
        ...
        String token =
                "NXS1"
                        ...
                        + base64.encodeToString(
                                ByteBuffer.allocate(12 + sealed.length)
                                        .put(nonce)
                                        .put(sealed)
                                        .array());
        String password =
                base64.encodeToString(
                        Arrays.copyOf(
                                hmac(
                                        utf8(secret),
                                        "nxs-stateless-ice-v1\0" + audience + "\0" + token),
                                24));
