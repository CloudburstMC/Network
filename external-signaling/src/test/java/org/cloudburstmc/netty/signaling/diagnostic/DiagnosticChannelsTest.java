...
class DiagnosticChannelsTest {
    @Test void callbackOwnsOneFrameAndDoesNotReopenAfterConsumption() {
    ...
    @Test void invalidSizeChannelAndTextCannotQueueApplicationData() {
    ...
    @Test void aBurstCannotGrowTheSingleFrameMailbox() {
        DiagnosticChannels channels = new DiagnosticChannels();
