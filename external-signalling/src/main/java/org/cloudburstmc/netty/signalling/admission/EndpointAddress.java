...
public final class EndpointAddress {
    ...
    public static InetAddress parse(String value) throws UnknownHostException {
        ...
        if ((!value.contains(":") || value.contains(".")) && !dotted.matches(
    ...
    public static Scope scope(InetAddress address) {
        ...
        if (raw.length == 4) {
            ...
            if (a == 10 || (a == 172 && b >= 16 && b <= 31) || (a == 192 && b == 168) || (a == 100 && b >= 64
                    && b <= 127)) {
            ...
            if ((a == 192 && b == 0 && c == 2) || (a == 198 && b == 51 && c == 100) || (a == 203 && b == 0
                    && c == 113)) {
                return Scope.DOCUMENTATION;
            }
            if (a == 0 || a >= 224 || (a == 169 && b == 254) || (a == 198 && (b == 18 || b == 19)) ||
                    (a == 192 && b == 88 && c == 99) || (a == 192 && b == 0 && c == 0 && d != 9 && d != 10)) {
        ...
        for (int i = 0; i < words.length; i++) {
            words[i] = ((raw[i * 2] & 255) << 8) | (raw[i * 2 + 1] & 255);
        }
        ...
        if ((a == 0x2001 && b == 0xdb8) || (a == 0x3fff && b < 0x1000)) {
            return Scope.DOCUMENTATION;
        }
        if ((a & 0xe000) != 0x2000 || a == 0x2002) {
            return Scope.UNUSABLE;
        }
        if (a == 0x2001 && b < 0x200) {
            boolean zeroMiddle = true;
            for (int i = 2; i < 7; i++) {
                zeroMiddle &= words[i] == 0;
            }
