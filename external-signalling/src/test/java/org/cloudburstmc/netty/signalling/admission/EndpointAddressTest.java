...
class EndpointAddressTest {
    @Test
    void classifiesPrivateSharedAndPublicBoundaries() throws Exception {
        for (String ip : new String[]{"10.0.0.1", "172.16.0.1", "172.31.255.255", "192.168.1.1", "100.64.0.1",
                "100.127.255.255", "fc00::1", "fd7a:115c:a1e0::1"}) {
            assertEquals(EndpointAddress.Scope.PRIVATE, EndpointAddress.scope(EndpointAddress.parse(ip)), ip);
        }
        for (String ip : new String[]{"8.8.8.8", "172.15.255.255", "172.32.0.0", "100.63.255.255", "100.128.0.0",
                "192.0.0.9", "2606:4700:4700::1111", "2001:4860::1"}) {
