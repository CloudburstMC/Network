...
public class RakDatagramPacket extends AbstractReferenceCounted {
    ...
    private static final ObjectPool<RakDatagramPacket> RECYCLER = ObjectPool.newPool(new ObjectPool.ObjectCreator<RakDatagramPacket>() {
        public RakDatagramPacket newObject(ObjectPool.Handle<RakDatagramPacket> handle) {
